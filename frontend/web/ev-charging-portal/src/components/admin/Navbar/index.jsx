      ...
      <div className="flex items-center gap-3.5">
        ...
        <div className="flex items-center gap-2.5 select-none">
          ...
          <div className="font-bold text-[15px] text-[#07122a]">
            EV Charging{" "}
            <span className="text-[#0f62fe] font-extrabold ml-1">Admin</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 relative">
        <div className="min-w-[260px] max-[900px]:hidden">
          <input
            ...
            placeholder="Tìm kiếm người dùng, trạm..."
            aria-label="Search"
          />
        </div>
            ...
            <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-[rgba(0,0,0,0.05)] p-5 animate-fadeIn">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="text-[14px] text-[#6b7280] mt-1 w-full text-left">
                  <p>
                    <strong>Phone:</strong> {user.phone || "Chưa có"}
                  </p>
                  <p>
                ...
                <div className="flex gap-2 mt-5 w-full">
                  <button
                    ...
                    onClick={() => alert("Đi tới trang chỉnh sửa admin profile")}
                  >
                    ✏️ Chỉnh sửa
                  </button>
