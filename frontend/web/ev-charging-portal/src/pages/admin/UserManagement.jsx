...
// - Cho phép khoá / mở khoá / set role
export default function UserManagement() {
  ...
  const deleteUser = async (id) => {
    if (!window.confirm("Xoá user này? Dữ liệu login sẽ không dùng được nữa.")) {
      return;
    }
    try {
    ...
    <div className="min-h-screen bg-slate-50 px-6 py-8">
      <div className="max-w-7xl mx-auto space-y-6">
        <PageHeader
          ...
          subtitle="Quản lý tài khoản driver / staff / admin – tất cả thao tác đều qua API."
        />
