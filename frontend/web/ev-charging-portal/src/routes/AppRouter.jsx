...
// ❌ Tạm bỏ PrivateRoute khi test UI
...
const routeConfig = [
  ...
  // 👨‍💼 Staff routes (bỏ roles để vào thẳng link)
  ...
  { path: ROUTERS.STAFF.SETTINGS, element: Settings, layout: StaffLayout },
  ...
  return (
    <Routes>
      {routeConfig.map((route) => {
        ...
        // 🚀 Không còn kiểm tra roles, vào thẳng luôn
